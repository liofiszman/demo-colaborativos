...
public class Dao {
    ...
    public CompaniaSeguro read_compania_seguro(Integer id) throws Exception {
        String sql = "select * from compania_seguros where id=?";
        DataStore.RowData rd = ds.queryRow(sql, id);
        CompaniaSeguro obj = new CompaniaSeguro();
        obj.set_id(rd.getValue(Integer.class, "id"));  // t <- t
        obj.set_nombre(rd.getValue(String.class, "nombre"));  // t <- t
    ...
    public int update_compania_seguro(CompaniaSeguro p) throws Exception {
        ...
        return ds.execDML(sql, p.get_nombre(), p.get_id());
    }
    ...
    public int update_compania_seguro(String nombre, Integer id) throws Exception {
        String sql = "update compania_seguros set nombre=? where id=?";
        return ds.execDML(sql, nombre, id);
    }

    /*
        CRU(D): compania_seguros
        Returns the number of affected rows or -1 on error.
     */
    ...
    public List<HorarioAtencion> read_horario_atencion_list() throws Exception {
        ...
        ds.queryAllRows(sql, new DataStore.RowHandler() {
            ...
            public void handleRow(DataStore.RowData rd) throws Exception {
                ...
                obj.set_hora_desde(rd.getValue(LocalDate.class, "hora_desde"));  // t <- t
                obj.set_hora_hasta(rd.getValue(LocalDate.class, "hora_hasta"));  // t <- t
    ...
    public List<Turno> read_turno_list() throws Exception {
        ...
        ds.queryAllRows(sql, new DataStore.RowHandler() {
            ...
            public void handleRow(DataStore.RowData rd) throws Exception {
                ...
                obj.set_hora(rd.getValue(LocalDate.class, "hora"));  // t <- t
                obj.set_mecanico_id(rd.getValue(Integer.class, "mecanico_id"));  // t <- t
